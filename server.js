...
// WICHTIG: Setze in Render bei "Environment Variables" die Variable MONGODB_URI
const MONGO_URI = process.env.MONGODB_URI || 'DEIN_MONGODB_CONNECTION_STRING';
mongoose.connect(MONGO_URI).then(() => console.log("MongoDB verbunden")).catch(err => console.error("DB Fehler:", err));
...
// Hier das Modell korrekt definieren
...
// Admin-Endpunkt: Sessions abrufen (KORRIGIERT)
app.get('/get-sessions', async (req, res) => {
    ...
    try {
        // Hier wurde 'Session' statt 'SessionModel' verwendet
